...
#
# Combobox / Dropdown listbox-widget
#
# Code is freely distributable without restriction, but is
...
namespace eval ::combobox {
	...
	# References to available options
	variable widgetOptions

	# References to available commands and subcommands
