...
# All Rights Reserved
#
# Code is freely distributable, but is provided as-is with
...
package provide supertext 1.02
...
# When called, it will rename the tk command "text" to "_text_",
...
proc supertext::widgetproc {this w command args} {
   ...
   global mydata
	...
	insert {
		...
		# this is saved to variable: length
		####################################
	...
	delete {
		...
		# For binding to delete-actions
		event generate $this <<DDD>>
